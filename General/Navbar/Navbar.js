    ...
    function setNavigationBar() {
        ...
        if (navigationbar) {
            ...
            <div class="navbar">
                ...
                <div class="navright" id="navright">
                    ...
                    <div class="navuser">
                        ...
                        <a href="#navuser" class="multicon multiconacc hide" id="multiconbar2">
                            <div>Log Out</div>
                        </a>
                    </div>
                </div>
            ...
            <div class="navbutton navradius navhide hide" id="navbutt">
                ...
                <div class="navitem navuser navhide" id="navuser">
                    <i class="fa fa-user"></i>
                    <a href="#navuser" class="multicon multiconacc hide" id="rmulticon7">
                        <div>Account</div>
                    </a>
                    <a href="#navuser" class="multicon multiconacc hide" id="rmulticon8">
                        <div>Log Out</div>
                    </a>
                </div>
            </div>
